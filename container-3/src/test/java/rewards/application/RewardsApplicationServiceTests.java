...
public class RewardsApplicationServiceTests {
	...
	public void setUp() throws Exception {
		...
		// TODO 3a: Rename test-infrastructure-config.xml to system-test-config.xml
		// TODO 3b: Modify the code below to only load system-test-config.xml
		// TODO 3c: Modify system-test-config.xml to <import /> app-config.xml
