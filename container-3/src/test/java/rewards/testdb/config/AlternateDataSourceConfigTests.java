...
public class AlternateDataSourceConfigTests {
	...
	private void getConnection(DataSource dataSource) throws SQLException {
		...
		assertEquals(1, (int) jdbcTemplate.queryForObject(
				"SELECT COUNT(*) FROM T_MERCHANT", Integer.class));
	}
